    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_pdf:
                ...
                break;
            case  R.id.btn_ppt:
                String  ppt_url="http://dl.wdcloud.cc//wh1/M03/AD/CD/oYYBAF5pwdCAakPdAAAgNgV8yPE62.xlsx";
                intent.putExtra("URL",ppt_url);
                startActivity(intent);
                break;

            case  R.id.btn_word:
                String word_url="http://dl.wdcloud.cc//wh4/M00/59/08/p4YBAF5pwdCAU-UrAAAyFaWhqJ811.docx";
